...
internal sealed class CleoMaxArtifact : Artifact, IRegisterable
{
	...
	public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
	{
		...
		helper.Content.Artifacts.RegisterArtifact("CleoMax", new()
		{
			...
			Sprite = helper.Content.Sprites.RegisterSprite(ModEntry.Instance.Package.PackageRoot.GetRelativeFile("assets/Cull/Artifacts/Duo/CleoMax.png")).Sprite,
		...
		api.RegisterDuoArtifact(MethodBase.GetCurrentMethod()!.DeclaringType!, [ModEntry.Instance.CullDeck.Deck, Deck.hacker]);
	}
