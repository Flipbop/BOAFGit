        ...
        LocalDB.DumpStoryToLocalLocale("en", new Dictionary<string, DialogueMachine>()
        {
            ...
            {"Luna_Memory_2", new(){
                ...
                dialogue = [
                    ...
                    new (AmKass, "failonpurpose", "*click*", true),
                    new (AmDillian, "Who was that?", true),
                    new (AmLuna, "My girlfriend, Kass."),
                    new (AmDillian, "Oh, how nice. You mentioned her before.", true),
                    new (AmLuna, "Mhm!"),
                    new (AmDillian,  "Didn't you also say that you were both protectors of your village?", true),
            ...
            {"Luna_Memory_3", new(){
                ...
                dialogue = [
                    ...
                    new (AmLuna, "squint", "Why?"),
                    new (AmDillian, "squint", "I just got word that your village is under siege from a group of pirates...", true),
                    new (AmLuna, "nervous", "Oh no, Kass is all alone without me!"),
                    new (AmDillian, "How fast do you think you could make it back?", true),
            ...
            {"Luna_Closure", new(){
                ...
                dialogue = [
                    ...
                    new (AmLuna, "sob", "I shouldn't have left for college, you would still be alive if I never went."),
