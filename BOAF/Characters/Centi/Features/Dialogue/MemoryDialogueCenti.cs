        ...
        LocalDB.DumpStoryToLocalLocale("en", new Dictionary<string, DialogueMachine>()
        {
            ...
            {"Centi_Memory_1", new(){
                ...
                dialogue = [
                    ...
                    new(title: null),
                    new(new Wait{secs = 1 }),
                    new (AmLivingCenti, "neutral", "Almost there..." ),
                    ...
                    new (AmLivingCenti, "nervous", "They found us!" ),
                    new (AmDrake, "panic","Oh no, I'm not getting caught up with them! I'm out!", true ),
                    new (AmLivingCenti, "nervous", "What?! Drake, we're partners!" ),
                    new (AmDrake, "panic","Sorry, but the AVON Guard are the real deal!", true ),
                    new (AmDrake, "messitupsoshedisappears","...", true ),
                    new (AmLivingCenti, "nervous", "...Drake..." ),
                    new (AmGuard, "Your \"friend\" left you. No hiding now.", true ),
                    new (AmLivingCenti, "neutral", "I'm not just going to give in." ),
            ...
            {"Centi_Memory_2", new(){
                ...
                dialogue = [
                    ...
                    new(title: null),
                    new(new Wait{secs = 1 }),
                    new (new BGAction(){action = "argument"}),
                    ...
                    new(AmCenti, "angry", "If you hadn't abandoned me we both could have lived!"),
                    new (AmDrake, "panic","You know how dangerous the AVON Guard is! We would both be dead!", true ),
                    new(AmCenti, "angry", "That would be better than living as a hollow shell! Look what you did to me!"),
                    new (AmDrake, "sad","I worked so hard to bring you back. I thought you would be happy!", true ),
                    new(AmCenti, "angry", "I'm living in a corpse! How could I be happy?!"),
                    new (AmDrake, "sad","But I-", true ),
                    new(AmCenti, "angry", "No, that's enough from you! I don't EVER want to see you again!"),
                ...
                dialogue = [
                    ...
                    new (new MemoryFight()
                    {
                        ...
                        artifacts = new List<Artifact>
                        {
                            ...
                            new DemonHeartArtifact(),
                            new AquaHeartArtifact(),
                            new StoneHeartArtifact()
                        },
                        decks = new List<Deck>
                        {
            ...
            {"Centi_Closure", new(){
                ...
                dialogue = [
                    ...
                    new (AmLivingCenti, "makethemVANISH", "...", true),
                    new (AmCenti, "sob", "..."),
