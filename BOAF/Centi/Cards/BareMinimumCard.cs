...
internal sealed class BareMinimumCard : Card, IRegisterable
{
	...
	public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
	{
		...
		helper.Content.Cards.RegisterCard(MethodBase.GetCurrentMethod()!.DeclaringType!.Name, new()
		{
			...
			Art = StableSpr.cards_colorless,//helper.Content.Sprites.RegisterSprite(package.PackageRoot.GetRelativeFile("assets/Centi/Cards/BareMinimum.png")).Sprite,
			Name = ModEntry.Instance.AnyLocalizations.Bind(["Centi","card", "BareMinimum", "name"]).Localize
		});
	}
