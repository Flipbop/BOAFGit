...
public class Backgrounds
{
    ...
    public class BGRunWinCustom : BG {
        ...
        public override void OnAction(State s, string action) {
            ...
            else if (action == "runwinwho_reset_Jay") {
                charPickDeck = null;
            ...
            /*else if (action == "runwinwho_reset_Luna") {
                ...
                s.storyVars.runWinChar = null;
                charPickTimer = null;
                s.storyVars.memoryUnlockLevel[ModEntry.Instance.EvaDeck.Deck] = 1;
                s.ChangeRoute(s.MakeRunWinRoute);
            }
            else if (action == "runwinwho_reset_Cull") {
                charPickDeck = null;
                s.storyVars.runWinChar = null;
                charPickTimer = null;
                s.storyVars.memoryUnlockLevel[ModEntry.Instance.CullDeck.Deck] = 1;
                s.ChangeRoute(s.MakeRunWinRoute);
            }*/
        }
